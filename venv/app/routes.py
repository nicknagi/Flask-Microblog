...
# If there is a corresponding user with the email ID enetered then send a reset email
...
# Check if password reset token is valid if yes, then allow user to change password
